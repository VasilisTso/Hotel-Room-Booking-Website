    ...
    if(isset($_GET['gen_pdf']) && isset($_GET['id']))
    {
        ...
        $table_data = "
            ...
            <table border='1'>
                ...
                <tr>
                    <td colspan='2'>Phone number: $data[phonenum]</td>
                </tr>
                <tr>
                    <td>Room name: $data[room_name]</td>
                    <td>Cost: €$data[price] / night</td>
                </tr>
                <tr>
        ...
        if($data['booking_status']=='canacelled'){
            $refund = ($data['refund']) ? "Ammount Refunded" : "Not Yet Refunded";
