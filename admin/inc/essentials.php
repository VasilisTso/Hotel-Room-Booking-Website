<?php
    ...
    //backends upload process data
    define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/HotelBookingWebsite/');
    define('FEATURES_FOLDER','images-features/');
    define('ROOMS_FOLDER','images-rooms/');
    define('USERS_FOLDER','images-users/');

    //sendgrid API key
    define('SENDGRID_API_KEY',"API_KEY_HERE");
    define('SENDGRID_EMAIL',"billthetso@gmail.com");
    define('SENDGRID_NAME',"VASILIS");
