...
<body class="color-bg">
  ...
  <?php 
    ...
    /*
      Check if room id from url is present or not (ex. confirm_booking.php?id=6)
      Shutdown is active or not
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 col-md-12 px-4">
        <div class="card mb-4 order-0 shadow-sm rounded-3">
          <div class="card-body">
              <form action="pay_now.php" id="booking_form">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    ...
                    <h6 class="mb-3 text-danger text-center" id="pay_info">Provide check-in & check-out dates.</h6>
      ...
      if(checkin_val!='' && checkout_val!=''){
        ...
        xhr.onload = function(){
          ...
          if(data.status == 'check_in_out_equal'){
            pay_info.innerText = "You cannot check-out the same day."
          }
          else if(data.status == 'check_out_earlier'){
            pay_info.innerText = "You cannot check-out earlier than the check-in date."
          }
