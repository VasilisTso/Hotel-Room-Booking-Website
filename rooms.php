...
<body class="color-bg">
  ...
  <div class="container-fluid">
    <div class="row">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px">
                  ...
                  <button id="chk_avail_btn" onclick="chk_avail_clear()" class="btn shadow-none btn-outline-secondary btn-sm text-secondary d-none">Reset</button>
                </h5>
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px">
                  ...
                  <button id="facilities_btn" onclick="facilities_clear()" class="btn shadow-none btn-outline-secondary btn-sm text-secondary d-none">Reset</button>
                </h5>
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px">
                  <span>Guests</span>
                  <button id="guests_btn" onclick="guests_clear()" class="btn shadow-none btn-outline-secondary btn-sm text-secondary d-none">Reset</button>
                </h5>
                <div class="d-flex">
                  <div class="me-3">
      ...
      <!-- main body - room cards (in ajax/rooms.php) -->
  ...
  <script>
    ...
    function fetch_rooms()
    {
      ...
      xhr.onprogress = function(){
        room_data.innerHTML = `<div class="spinner-border text-info mb-3 mx-auto" id="loader" role="status">
