<?php 
    ...
    if(isset($_GET['fetch_rooms']))
    {
        ...
        //count num of rooms and output var to store room cards
        $count_rooms = 0;
        $output = "";

        //fetching settings table to check if website is shutdown mode
        ...
        {
            //run query check room available or not
            if($chk_avail['checkin']!='' && $chk_avail['checkout']!=''){
            ...
            // print room card
            $output.="
                <div class='card mb-4 order-0 shadow'>
                    <div class='row g-0 p-3 align-items-center'>
                        ...
                        <div class='col-md-5 px-lg-3 px-md-3 px-0'>
                            ...
                            <div class='guests mb-3'>
                                ...
                                <span class='badge rounded-pill bg-light text-dark mb-3 text-wrap'>
                                    $room_data[children] Child/Children
                                </span>
                            </div>
                        </div>
